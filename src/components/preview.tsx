...
import { IStatus, TAG_STYLES, type IArticle, type IContactFormConfiguration, type IPage, type ITag, type ITagStyle } from '@/types'
...
const PreviewContactForm = ({ configuration, fieldId, values }: { configuration: IContactFormConfiguration; fieldId?: string; values: FormData }) => {
    ...
    const updatedField = parseContactFieldFromFormData(values, currentField)
...
/** Aperçu statique sans saisie live : utiliser AdminMutationForm pour les formulaires éditables. */
